...
class SeeTracksAdapter(
    ...
    inner class ViewHolderTracks(
        ...
        val modifyTrackLength = tracksView.findViewById(R.id.imageViewModifyTrackLength) as ImageView

        val constraintLayout: ConstraintLayout = tracksView.findViewById(
            R.id.constraintLayoutSeeTracks
        )
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(
            R.layout.item_general_see_tracks,
            parent,
            false
        )
